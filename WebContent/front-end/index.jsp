            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="<%=request.getContextPath()%>/sources/images/carousel-1.jpg" alt="Carousel Image">
                    ...
                    <div class="carousel-item">
                        <img class="filter" src="<%=request.getContextPath()%>/sources/images/carousel-2.jpg" alt="Carousel Image">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="<%=request.getContextPath()%>/sources/images/carousel-3.jpg" alt="Carousel Image">
                        <div class="carousel-caption">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-6">
                            <div class="about-img">
                                <img src="<%=request.getContextPath()%>/sources/images/about.png" alt="About Image">
                            </div>
                        </div>
